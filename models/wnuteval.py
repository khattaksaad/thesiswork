...
#change in line_to_toks, thats where split of line is defined
...
#wnut_tags = ('sportsteam', 'geo-loc', 'musicartist', 'other', 'person', 'product','movie','facility','tvshow','company')
